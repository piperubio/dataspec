...
export const initCommand = new Command()
    .name('init')
    .description('Initialize a new DPAC project')
...
version: "0.1.0"
description: Data platform defined with DPAC
...
`;
        ...
        console.log(`Initialized DPAC project '${projectName}' at ${projectPath}`);
        console.log('Run "dpac validate" to validate your workspace.');
    }
    catch (error) {
...
async function createExamples(projectPath) {
