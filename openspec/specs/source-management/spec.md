...
The system SHALL support declaring external data producers (databases, APIs, file systems, SaaS applications) with their type and available entities. Connection details and credentials are NOT included — dpac-core is definitions-only.
...
The system SHALL restrict source types to a defined set: `database`, `api`, `file_system`, `saas`.
