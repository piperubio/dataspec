...
- _Sphinx/reStructuredText_: Better cross-references but requires build step and hosting
- _Docusaurus/VuePress_: Richer UX but requires Node.js build and deployment
- _PlantUML_: Less widely supported than Mermaid on GitHub
