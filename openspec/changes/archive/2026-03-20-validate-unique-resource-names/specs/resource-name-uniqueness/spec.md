...
Validates that all resource names within each category are unique across the workspace, preventing ambiguous references and ensuring reliable cross-resource linking.
